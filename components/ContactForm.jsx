...
const ContactForm = () => {
  ...
  // Helper to URL-encode body for Netlify
  const encode = (data) =>
    Object.keys(data)
      .map(
        (key) =>
    ...
    >
      ...
      <div className="ptf-form-group">
        ...
        {errors.campaignInterest && (
          <div className="invalid-feedback">
            {errors.campaignInterest.message}
          </div>
        )}
      </div>
      ...
      <div className="ptf-form-group">
        <label data-number="05">
          Which location or township do you want to reach?
        </label>
        <input
          type="text"
          {...register("location")}
      ...
      <div className="ptf-form-group agreement-checkbox">
        ...
        <label className="ptf-checkbox" htmlFor="acceptTerms">
          ...
          I agree to receive updates about Straat Africa's advertising
          opportunities.
        </label>
        {errors.acceptTerms && (
      ...
      {status === "success" && (
        <p style={{ marginTop: "1rem", color: "var(--ptf-accent-1)" }}>
